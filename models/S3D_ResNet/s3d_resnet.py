...
class STBasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=(1, 1, 1), padding=0, downsample=None, dw_t_conv=False):
...
if __name__ == '__main__':
    ...
    model = s3d_resnet(18, 400, 0.5, without_t_stride=False, dw_t_conv=False)
