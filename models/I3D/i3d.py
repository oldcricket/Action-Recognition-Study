...
class InceptionI3D(nn.Module):
    ...
    def __init__(self, num_classes=400, spatial_squeeze=True, final_endpoint='logits',
        ...
        end_point = 'AvgPool_5'
        self.layers[end_point] = nn.AvgPool3d(kernel_size=[2, 7, 7], stride=(1, 1, 1)) # Change this for different sample duration, for 64: [8,7,7]
...
def i3d(num_classes, input_channels, dropout, **kwargs):
    model = InceptionI3D(num_classes=num_classes, spatial_squeeze=True, final_endpoint='logits',
                         in_channels=input_channels, dropout_keep_prob=1.0 - dropout)
    return model
